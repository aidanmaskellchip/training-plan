...
func TestGetDayByIndex(t *testing.T) {
	...
	aw := ActivityWeek{
		Mon: Activity{Distance: 1.0},
		Tue: Activity{Distance: 2.0},
		Wed: Activity{Distance: 3.0},
		Thu: Activity{Distance: 4.0},
		Fri: Activity{Distance: 5.0},
		Sat: Activity{Distance: 6.0},
		Sun: Activity{Distance: 7.0},
	}
...
func TestGetEasyRunDay(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			runningDays: RunningDays{Days: []int{1, 1, 1, 1, 1, 1, 1}}, // All running days
		...
		},
		{
			...
			runningDays: RunningDays{Days: []int{0, 0, 0, 0, 0, 0, 0}}, // No running days
		...
		},
		{
			...
			runningDays: RunningDays{Days: []int{0, 0, 0, 1, 0, 0, 0}}, // Only Thursday is a running day
